...
PVRLanetTVData		*m_data = NULL;
bool				m_bIsPlaying = false;
PVRLanetTVChannel	m_currentChannel;
...
std::string		ApiUrl = "https://api.lanet.tv/";
std::string		StaticUrl = "https://static.lanet.ua/";
std::string		g_strLogoPath = StaticUrl + "tv/logo/";
std::string		g_strEPGPath = ApiUrl + "epg/";
std::string		g_strListPath = ApiUrl + "list.json";
...
{
	XBMC->Log(LOG_DEBUG, "%s - Load addon settings", __FUNCTION__);
  //STUB
}
...
ADDON_STATUS ADDON_Create(void* hdl, void* props)
{
  ...
  XBMC->Log(LOG_DEBUG, "%s - Creating the PVR LanetTV add-on", __FUNCTION__);
...
{
  static const char *strBackendName = "LanetTV PVR Add-on";
...
{
  snprintf(signalStatus.strAdapterName, sizeof(signalStatus.strAdapterName), "LanetTV Adapter 1");
